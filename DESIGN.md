...
| `policy.test.ts` | Table-driven: each ruleId has allow + deny fixtures; `velocity.window` escalates a new hire/fund/FX settle after a hot hour and allows complete-after-fund and reads |
