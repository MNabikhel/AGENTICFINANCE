...
export interface PolicyContext {
  ...
  fundsOk?: boolean;                // false when a transfer or hire.fund would overdraw the source book
}
```
...
| 56 | `ledger.sufficient` | ledger.transfer / hire.fund | source book (transfer fromAccount, or buyer cash at fund) balance < amount | — | source covers the cents (zero is legal) |
