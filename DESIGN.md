...
A founder nests a scout under a desk hop. The scout funds while the parent lives. After the parent hop dies, a new `hire.create` is `kya.parent_fresh` and writes nothing. That funded work still releases. A nested hop does not outlive its parent. Still 87 rules.
