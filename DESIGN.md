...
| 85 | `market.fx_fresh` | quote with an `fx` object | `validUntil` ≤ now, or unparseable Instant | — | FX window still open at mint (settle of a later lapse stays `market.not_expired`) |
