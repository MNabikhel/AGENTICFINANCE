...
| 32 | `kya.capability_subset` | attest / spend | agent grants above own level (omitted `maxAutonomy` is L5), or acts above granted max | — | within grant |
