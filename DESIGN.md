...
| 84 | `kya.parent_fresh` | kya.attest with a known parentId; hire.create / hire.fund / issue_intent along a nested hop | parent hop is expired or revoked (`hopStatus` is not live) | — | parent hop still lives (ghost stays `kya.known_parent`; completing a funded hire after that is legal) |
