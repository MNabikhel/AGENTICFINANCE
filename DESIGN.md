...
| 82 | `mandate.occurrence_fresh` | issue_intent with agent_recurrence | max_occurrences ≤ 0, or not a finite number (omit is unlimited and still mints) | — | cadence can still admit a first hire |
