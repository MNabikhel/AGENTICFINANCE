...
The ten TAP demos exist. KYA issuers are genesis objects (`iss_`), shape-only. Further work is sequenced in [`docs/FOUNDATION.md`](docs/FOUNDATION.md). Do not add a UI. Do not add a live rail. Do not grind inspect overlays unless the pin would otherwise lie.
