...
| `schema.test.ts` | Listed enums, integer ranges, JSON types, and nested cart/constraint fields in `commands.schema.json` are 400 at the shape gate |
