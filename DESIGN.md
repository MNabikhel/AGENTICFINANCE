...
| `schema.test.ts` | Listed enums, integer ranges, JSON types, nested cart/constraint fields, and listed constraint value fields in `commands.schema.json` are 400 at the shape gate |
