...
describe("host card", () => {
  ...
  it("pins a discovery card that is this runtime, not an A2A JSON-RPC server", () => {
    ...
    expect(card.skills.some((s) => s.id === "market-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "market-party")?.description).toContain("POST /v1/demo/fold");
    expect(card.skills.some((s) => s.id === "mandate-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "mandate-party")?.description).toContain("POST /v1/demo/rip");
    expect(card.skills.some((s) => s.id === "rfq-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "rfq-party")?.description).toContain("POST /v1/demo/shut");
    expect(card.skills.some((s) => s.id === "cart-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "cart-party")?.description).toContain("POST /v1/demo/dump");
    expect(card.skills.some((s) => s.id === "payment-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "payment-party")?.description).toContain("POST /v1/demo/spike");
    expect(card.skills.some((s) => s.id === "cadence-reach")).toBe(true);
    expect(card.skills.find((s) => s.id === "cadence-reach")?.description).toContain("POST /v1/demo/week");
    expect(card.skills.some((s) => s.id === "range-fresh")).toBe(true);
    expect(card.skills.find((s) => s.id === "range-fresh")?.description).toContain("POST /v1/demo/gulf");
    expect(card.skills.some((s) => s.id === "budget-fresh")).toBe(true);
    expect(card.skills.find((s) => s.id === "budget-fresh")?.description).toContain("POST /v1/demo/coffer");
    expect(card.skills.some((s) => s.id === "currency-fresh")).toBe(true);
    expect(card.skills.find((s) => s.id === "currency-fresh")?.description).toContain("POST /v1/demo/clash");
    expect(card.skills.some((s) => s.id === "hatch-fresh")).toBe(true);
    expect(card.skills.find((s) => s.id === "hatch-fresh")?.description).toContain("POST /v1/demo/hatch");
    expect(card.skills.some((s) => s.id === "cap-fresh")).toBe(true);
    expect(card.skills.find((s) => s.id === "cap-fresh")?.description).toContain("POST /v1/demo/eave");
    expect(card.skills.some((s) => s.id === "grant-fresh")).toBe(true);
    expect(card.skills.find((s) => s.id === "grant-fresh")?.description).toContain("POST /v1/demo/sill");
    expect(card.skills.some((s) => s.id === "nest-tighter")).toBe(true);
    expect(card.skills.find((s) => s.id === "nest-tighter")?.description).toContain("POST /v1/demo/joist");
    expect(card.skills.some((s) => s.id === "path-tighter")).toBe(true);
    expect(card.skills.find((s) => s.id === "path-tighter")?.description).toContain("POST /v1/demo/stud");
    expect(card.skills.some((s) => s.id === "path-live")).toBe(true);
    expect(card.skills.find((s) => s.id === "path-live")?.description).toContain("POST /v1/demo/plate");
    expect(card.skills.some((s) => s.id === "child-currency")).toBe(true);
    expect(card.skills.find((s) => s.id === "child-currency")?.description).toContain("POST /v1/demo/header");
    expect(card.skills.some((s) => s.id === "payout-fresh")).toBe(true);
    expect(card.skills.find((s) => s.id === "payout-fresh")?.description).toContain("POST /v1/demo/pip");
    expect(card.skills.some((s) => s.id === "fx-maker")).toBe(true);
    expect(card.skills.find((s) => s.id === "fx-maker")?.description).toContain("POST /v1/demo/quoin");
    expect(card.skills.some((s) => s.id === "rate-fresh")).toBe(true);
    expect(card.skills.find((s) => s.id === "rate-fresh")?.description).toContain("POST /v1/demo/ashlar");
    expect(card.skills.some((s) => s.id === "nest-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "nest-party")?.description).toContain("POST /v1/demo/corbel");
    expect(card.skills.some((s) => s.id === "checkout-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "checkout-party")?.description).toContain("POST /v1/demo/trolley");
    expect(card.skills.some((s) => s.id === "hire-room-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "hire-room-party")?.description).toContain("POST /v1/demo/poach");
    expect(card.skills.some((s) => s.id === "hire-slip-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "hire-slip-party")?.description).toContain("POST /v1/demo/guise");
    expect(card.skills.some((s) => s.id === "mandate-child-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "mandate-child-party")?.description).toContain("POST /v1/demo/cuckoo");
    expect(card.skills.some((s) => s.id === "mandate-root-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "mandate-root-party")?.description).toContain("POST /v1/demo/forge");
    expect(card.skills.some((s) => s.id === "settle-party")).toBe(true);
    expect(card.skills.find((s) => s.id === "settle-party")?.description).toContain("POST /v1/demo/snare");
  });
